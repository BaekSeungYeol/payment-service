...
class PaymentCompleteServiceTest(
    ...
    fun `should update payment given a WalletEventMessage`() {
        ...
        val orderId = createdPaymentEventWithSuccessStatus()
        ...
        assertThat(paymentEvent.isWalletUpdateDone()).isEqualTo(true)
        assertThat(paymentEvent.isLedgerUpdateDone()).isEqualTo(false)
        assertThat(paymentEvent.isPaymentDone()).isEqualTo(false)
    ...
    fun `should update payment given a LedgerEventMessage`() {
        ...
        assertThat(paymentEvent.isLedgerUpdateDone()).isEqualTo(true)
        assertThat(paymentEvent.isWalletUpdateDone()).isEqualTo(false)
        assertThat(paymentEvent.isPaymentDone()).isEqualTo(false)
    ...
    fun `should update payment given a LedgerEventMessage and WalletEventMessage`() {
        ...
        assertThat(paymentEvent.isLedgerUpdateDone()).isEqualTo(true)
        assertThat(paymentEvent.isWalletUpdateDone()).isEqualTo(true)
        assertThat(paymentEvent.isPaymentDone()).isEqualTo(true)

    }


    private fun createdPaymentEventWithSuccessStatus(): String {
